...
<body>
    ...
    <header class="top-header">
        ...
        <div class="header-profile">
            ...
            <?php
            $dh_att_search = '';
            if (!empty($dh_employee_id)) {
                $dh_att_search = urlencode($dh_employee_id);
            } elseif (!empty($dh_fullname)) {
                $dh_att_search = urlencode($dh_fullname);
            }
            ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Real-time Analytics for Dept Head (based on their personal attendance)
            (function(){
